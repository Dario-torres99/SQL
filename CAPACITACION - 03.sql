...
DROP PROCEDURE proc_insert_cliente 
...
DELETE FROM Customers WHERE customerid = 'CHB33' AND  CompanyName = 'visoal'AND  contactname = 'victor cardenas' OR Country = 'guatemala'
